...
def search_product(request):
    if request.method == 'GET':
        ...
        data = {
            'brands': [{'code_type': bt.brand_type, 'type_title': bt.brand_title} for bt in brands],
        }
        print(data)
...
def edit_product(request, product_id):
    if request.method == 'GET':
        ...
        products_data = {
            ...
            'product_image': request.build_absolute_uri(product.product_image.url) if product.product_image else None,
            'brand': product.brand.brand_type,
            'brands': [{'code_type': st.brand_type, 'type_title': st.brand_title} for st in Brands.objects.all()],
        }
